...
class TodolistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create todolist" do
    assert_difference("Todolist.count") do
      post todolists_url, params: { todolist: { add: @todolist.add, edit: @todolist.edit, mark: @todolist.mark, remove: @todolist.remove } }
    end
  ...
  test "should update todolist" do
    patch todolist_url(@todolist), params: { todolist: { add: @todolist.add, edit: @todolist.edit, mark: @todolist.mark, remove: @todolist.remove } }
